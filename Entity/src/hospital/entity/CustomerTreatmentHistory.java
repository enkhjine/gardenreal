...
@Entity
@Table(name = "CustomerTreatmentHistory")
public class CustomerTreatmentHistory implements Serializable {
	...
	public CustomerTreatmentHistory() {
		super();
	}

	public CustomerTreatmentHistory(CustomerTreatment ct) {
		super();

		this.pkId = ct.getPkId();
		this.inspectionPkId = ct.getInspectionPkId();
		this.inspectionDtlPkId = ct.getInspectionDtlPkId();
		this.treatmentPkId = ct.getTreatmentPkId();
		this.paymentPkId = ct.getPaymentPkId();
		this.qty = ct.getQty();
		this.times = ct.getTimes();
		this.dayLength = ct.getDayLength();
		this.createdDate = ct.getCreatedDate();
		this.createdBy = ct.getCreatedBy();
		this.updatedDate = ct.getUpdatedDate();
		this.updatedBy = ct.getUpdatedBy();
		this.customerPkId = ct.getCustomerPkId();
		this.doneCount = ct.getDoneCount();
		this.employeePkId = ct.getEmployeePkId();
		this.customerPkId = ct.getCustomerPkId();
		this.description = ct.getDescription();
	}

	public CustomerTreatmentHistory(CustomerTreatmentHistory customerTreatment, Treatment treatment,
			String employeeName, Customer c) {
		super();
