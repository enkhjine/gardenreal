...
@Entity
@Table(name = "ExaminationRequestTempSave")
public class ExaminationRequestTempSave implements Serializable {
	...
	public ExaminationRequestTempSave() {
		super();
	}

	public ExaminationRequestTempSave(BigDecimal pkId, BigDecimal customerPkId,
	...
	public ExaminationRequestTempSave(ExaRequest er) {
		super();
